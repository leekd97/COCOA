#!/bin/bash
# Exp 1: PMI on grounded only (alpha_g=1.0, alpha_n=0.0)
cd "$(dirname "$0")/.."
...
for FOLD in $(seq 0 $((K-1))); do
    ...
    EXP_NAME="${CULTURE}_${LANG}_${MODEL_SHORT}_${NEUTRAL_LOSS}_wg${W_GROUNDED}_wn${W_NEUTRAL}_tau${TAU}_r${LORA_R}_pnorm-g_fold${FOLD}_seed${SEED}"
    ...
    python main.py \
        ...
        --prior_alpha_g 1.0 --prior_alpha_n 0.0 \
