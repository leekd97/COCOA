#!/bin/bash
# Qwen KO exploration: alpha_n / w_g / w_n combos, fold 0
cd "$(dirname "$0")/.."
...
CONFIGS=(
    # "ko_an1.0_d5:1.0:1.0:5:1.0:2.0:10.0"
    # "ko_an0.7_d5:1.0:0.7:5:1.0:2.0:10.0"
    "ko_an0.3_d5_wg05:1.0:0.3:5:0.5:2.0:10.0"
    "ko_an0.3_d5_wn4_s5:1.0:0.3:5:1.0:4.0:5.0"
)

TOTAL=${#CONFIGS[@]}
COUNT=0

echo "[$(date)] Qwen KO Exploration: $TOTAL configs"
