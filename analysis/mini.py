...
# More robust model detection by substring
MODEL_PATTERNS = {
    "llama": ["llama3-8b", "llama-3", "llama3", "llama"],
    "qwen": ["qwen3-8b", "qwen2.5", "qwen3", "qwen"],
    "gemma": ["gemma-2", "gemma2", "gemma-3", "gemma3", "gemma"],
    "aya": ["aya-expanse", "aya-expanse", "aya-23", "aya"],
}
